              ...
              <Card className="min-h-64 min-w-48 flex flex-col justify-around items-center ">
                ...
                <CardContent className="flex justify-center">
                  <Dialog>
                    ...
                    <DialogContent className="w-[1080px] max-w-full overflow-y-scroll max-h-screen sm:rounded-none">
                      <DialogHeader>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          {person.endereco.length > 0 && (
                            <div className="flex  flex-col items-center w-full">
                              <div className="text-center bg-[#ededed] py-1 px-4 rounded-md  my-3 w-2/6">
                                <h2 className="font-semibold text-lg ">
                                  Endereço
                                </h2>
                              </div>
                              <div className="w-full">
                                {person.endereco.map((personEnd, indexEnd) => (
